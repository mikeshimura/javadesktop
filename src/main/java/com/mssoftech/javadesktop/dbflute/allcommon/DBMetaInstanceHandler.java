...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("login", "com.mssoftech.javadesktop.dbflute.bsentity.dbmeta.LoginDbm");
        tmpMap.put("session", "com.mssoftech.javadesktop.dbflute.bsentity.dbmeta.SessionDbm");
        tmpMap.put("sys_table", "com.mssoftech.javadesktop.dbflute.bsentity.dbmeta.SysTableDbm");
        tmpMap.put("user_table", "com.mssoftech.javadesktop.dbflute.bsentity.dbmeta.UserTableDbm");
