<content>
<div style={ "width:900px;height:600px;background-color:#F0F0F0;border:1px;border-style:solid;color:black;font-size:14px;"
    }>

    <div class="row"
        style={ "height:40px;color:#fff;background-color:#015666;font-size:20px;padding-top:5px;margin-right:0px;" }>
        <div class="col-xs-6">
    ...
    <div class="row" style={"margin-top:20px;"}>
        ...
        <div class="col-xs-4">
            <input type="checkbox" style={ "width:20px;margin-left:20px;" } name="setting#test"
                checked={$ws.setting.test} onchange={$c.onChecked} <span style="margin-left:0px;">チェックボックス</span>
    ...
    <table class="table table-bordered table-condensed wscrolltable" id="stable" style="width:300px;margin-left:120px;"
        if={$ws.setting.test}>
